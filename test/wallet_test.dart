...
void main() async {
  ...
  test('CruzPeer filter_add', (){
    ...
    for (int i = 0; i < 3; i++) {
      ...
      expect(appState.wallet.wallet.addresses.containsKey(msg['body']['public_keys'][0]), true);
      socket.sent.removeFirst();
  ...
  test('CruzPeer get_balance', (){
    ...
    for (int i = 0; i < 3; i++) {
      ...
      socket.sent.removeFirst();
      socket.messageHandler('{"type":"balance","body":{"block_id":"0000000000000ab4ac72b9b6061cb19195fe1a8a6d5b961f793f6b61f6f9aa9c","height":25352,"public_key":"$addr","balance":$balance}}');
    }
  });
  ...
  test('CruzPeer get_filter_transaction_queue', (){
    ...
    socket.sent.removeFirst();
    socket.messageHandler('{"type":"filter_transaction_queue","body":{"transactions":null}}');
  });
